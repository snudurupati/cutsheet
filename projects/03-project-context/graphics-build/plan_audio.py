...
def main():
    ...
    want = [
        ("s1", "ribhavagrawal-cinematic-reveal-type-01-265535", 0.0, "the hook lands"),
        ("s2", "musicmbuildings-deep-and-cinematic-woosh-sound-effect-318325",
         at("g003", "start"), "the architect takeover enters, full frame"),
        ("s3", "ribhavagrawal-cinematic-transition-type-02-265533",
         at("g003", "end"), "the architect takeover leaves"),
        ...
        ("s6", "musicmbuildings-deep-and-cinematic-woosh-sound-effect-318325",
         at("g028", "start"), "knowledge elicitation takeover enters"),
    ]
