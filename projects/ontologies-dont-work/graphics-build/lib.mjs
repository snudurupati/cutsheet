...
export const ART_X = 60, ART_Y = 170, ART_W = 960, ART_H = 590;
...
export const HOOK_PX = 80;   // measured max for the hook's best 2-line split is 81.8px
export const END_PX  = 100;
// One uniform body size for every sequential statement, so the type never
// changes weight or scale between beats. 64px is the largest that every line
// fits at after the two splits check_copy.py forced.
export const BODY_PX = 64;
export const END_PX2 = 88;   // the closing thesis; measured max is 100.2px
export const CTA_PX = 56;    // the brief's floor for essential text
export const SUPPORT_PX = 58;
...
.stmt{position:absolute;left:44px;right:44px;top:40px}
.cta{font-family:"SatoshiBold",sans-serif;font-weight:700;color:${PLAQUE_DIM};
  white-space:nowrap}
